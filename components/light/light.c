 ...
 * @LastEditTime: 2022-05-31 23:39:04
 * @FilePath: \11_Version1.0.1.20220531_RC\components\light\light.c
 * @Description: 
 * 
...
void light_set_pwm(uint16_t duty)
{
    ...
    // ESP_LOGI(TAG, "Current light duty is: %d", duty);
